...
class SettingSeeder extends Seeder
{
    ...
    {
        $id = Db::name('settings')->insertGetId(['parent_id' => 0, 'code' => 'setting', 'type' => 'hidden']);
    ...
    {
        $id = Db::name('settings')->insertGetId(['parent_id' => 0, 'code' => 'company', 'type' => 'hidden']);
        Db::name('settings')->insert([
    ...
    {
        $id = Db::name('settings')->insertGetId(['parent_id' => 0, 'code' => 'site', 'type' => 'hidden']);
        Db::name('settings')->insert([
    ...
    {
        $id = Db::name('settings')->insertGetId(['parent_id' => 0, 'code' => 'mail', 'type' => 'hidden']);
        Db::name('settings')->insert([
    ...
    {
        $id = Db::name('settings')->insertGetId(['parent_id' => 0, 'code' => 'sms', 'type' => 'hidden']);
        Db::name('settings')->insert([
    ...
    {
        $id = Db::name('settings')->insertGetId(['parent_id' => 0, 'code' => 'baidu', 'type' => 'hidden']);
        Db::name('settings')->insert([
